          ...
          <div class="form-layout">
            <div class="row mg-b-25">
              ...
              <div class="col-lg-4">
               ...
               <div class="col-lg-4">
                <div class="form-group">
                  <label class="form-control-label">Company Name English<span class="tx-danger">*</span></label>
                  <input class="form-control" type="text" name="company_name_en"  required="" value="{{ $setting->company_name_en }}">
                </div>
              </div><!-- col-4 -->

              <div class="col-lg-4">
                <div class="form-group">
                  <label class="form-control-label">Company Name Bangla<span class="tx-danger">*</span></label>
                  <input class="form-control" type="text" name="company_name_bn"  required="" value="{{ $setting->company_name_bn }}">
                </div>
              </div><!-- col-4 -->
