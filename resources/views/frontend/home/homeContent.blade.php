		...
		<div class="container fill_height">
			<div class="row fill_height">
				<div class="banner_product_image">
					<img src="{{asset( $banner->image_one )}}" alt=""></div>
...
@endphp					
						...
						@foreach($featured as $row)
									...
									<div class="featured_slider_item">
										...
										<a href="{{ url('product/details/'.$row->id.'/'.$row->product_name) }}">
											<img src="{{asset( $row->image_one )}}" style="height: 90px;width: 90px;" alt="">
										</a>
										</div>
										...
										@if($row->discount_price == Null)
										  <li class="product_mark " style="background: green;">new</li>
										@else
											@php
							...
							@foreach($trend as $row)
									<div class="featured_slider_item">
										<div class="border_active"></div>
										<div class="product_item discount d-flex flex-column align-items-center justify-content-center text-center">
											<div class="product_image d-flex flex-column align-items-center justify-content-center"><img src="{{asset($row->image_one)}}" style="height: 90px;width: 90px;" alt=""></div>
											<div class="product_content">
												<div class="product_price discount">
										@if($row->discount_price == NULL)
			                              ${{ $row->selling_price }}
								...
								@foreach($bestrated as $row)
									<div class="featured_slider_item">
			                            ...
			                            @endif
												...
												<div class="product_name"><div>
													<a href="product.html">{{ $row->product_name }}</a></div></div>
												<div class="product_extras">
													<div class="product_color">
														<input type="radio" checked name="product_color" style="background:#b19c83">
														<input type="radio" name="product_color" style="background:#000000">
	...
	<!-- Popular Categories -->
@php
	$popularCategory=DB::table('categories')
			->orderBy('id','DESC')
			->limit(24)
			->get();
@endphp
				...
				<div class="col-lg-9">
					...
					@foreach($popularCategory as $row)
							<div class="owl-item">
								...
								<div class="popular_category_image"><img src="{{asset( $row->category_icon )}}" alt=""></div>
							...
							<div class="row fill_height">
								...
								<div class="col-lg-8 col-md-6 fill_height">
									<div class="banner_2_image_container">
										<div class="banner_2_image"><img src="{{asset($row->image_one)}}" style="height: 350px; width: 370px;" alt=""></div>
									</div>
								</div>
							</div>
						</div>			
							...
							<div class="owl-item">
								<div class="trends_item is_new">
									...
									<div class="trends_content">
										...
										<div class="trends_name"><a href="#">{{ $row->product_name }}</a></div>
									...
									<ul class="trends_marks">
										...
										@if($row->discount_price == Null)
										  <li class="trends_mark trends_new" style="background: #17a2b8;">new</li>
										@else
											@php
												$amount=$row->selling_price-$row->discount_price;
												$discount=$amount/$row->selling_price*100;
       ...
       <div class="row">
          ...
          <div class="col-md-3">
              <form action="{{ route('insert.into.cart') }}" method="post">
                ...
                <div class="form-group" id="colordiv" style="padding-right: 60px;">
                  <label for="">Color</label>
                  <select name="color" class="form-control">
                  </select>
                </div>
                 <div class="form-group" id="sizediv"  style="padding-right: 60px;">
                ...
                <button type="submit" class="btn btn-primary" style="padding-right:25px;">Add To Cart</button>
              </form>
           </div>
         </div>
      </div>  
...
<!-- End Ajax for Popup Modal -->


	<!-- Add to Wishlist by Ajax -->
<script type="text/javascript">
