...
@section('dashboardContent')
    ...
    <div class="sl-mainpanel">
      ...
      <div class="sl-pagebody">
         ...
         <div class="row">
         	<div class="col-md-6" style="border: 2px solid lightgray;">
               <br>
         	    <div class="card">
   ...
   <a href="{{ url('admin/payment/cancel/'.$order->id) }}" class="btn btn-danger" id="delete">Cancel Order</a> -->
         ...
         @elseif($order->status == 2)
            ...
            <strong> PAYMENT ALREADY DONE AND YOUR PRODUCT ARE HANDOVER SUCCESSFULLY </strong>
         @elseif($order->status == 4)
            <strong class="text-danger">THIS ORDER ARE NOT VALID ITS CANCELED</strong>
         @else
            <strong class="text-success">THIS PRODUCT ARE SUCCESSFULLY DELEVERED</strong>
         @endif
