    ...
    <div class="row ">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header text-center">
                    <strong>{{ __('Change Your Password') }}</strong>
                </div>

                <div class="card-body">
                    <form method="POST" action="{{ route('user.password.update') }}" aria-label="{{ __('Reset Password') }}">
                        @csrf
        ...
        <div class="col-4">
                 <div class="card" style="width: 18rem;">
                    <br>
                  <img src="{{ URL::to( Auth::user()->image ) }}" class="card-img-top" style="height: 90px; width: 90px; margin-left: 34%; border-radius: 50%;" >
                  <div class="card-body">
