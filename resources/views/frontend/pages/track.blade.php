...
@section('title','My Order Tracking')
            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2"  style="border: 1px solid grey; padding: 20px;">
                    <div class="contact_form_container">
                        <div class="contact_form_title text-center"><b>Your Order Status</b></div> <br>
				...
				<span>
					     ...
					     <h4 style="text-align: center;">
					     	Note: Your Order are under review
					     </h4>
					     @elseif($track->status == 1)
					      <h4 style="text-align: center;">
					      	Note: Payment Accept Under Processing 
					      </h4>
					     @elseif($track->status == 2)
					      <h4 style="text-align: center;">
					      	Note: Packing Done Handover Progress 
					      </h4>
					     @elseif($track->status == 3)
					    <h4 style="text-align: center;">
					      Note: Successfully Delevered Your Order    
					  	</h4>
					     	@else
					    <h4 style="text-align: center;">
					     	Note: Order Cancel   
			...
			<div class="col-lg-12">
				<div class="cart_container">
					<div class="col-lg-6 offset-lg-3"  style="border: 1px solid grey; padding: 20px;">
		                <div class="contact_form_container">
		                    <div class="contact_form_title text-center"><b>Your Order Details</b></div> <br>
							    <div class="jumbotron">
									<ul>
